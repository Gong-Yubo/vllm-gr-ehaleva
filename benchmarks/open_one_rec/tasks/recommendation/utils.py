...
def compute_pass_at_k(predicted_sids: List[str], ground_truth_sids: Set[str], k: int) -> bool:
    """
...
def compute_position1_pass_at_k(
    predicted_sids: List[str], first_ground_truth_sid: str, k: int
) -> bool:
    """
...
def compute_recall_at_k(predicted_sids: List[str], ground_truth_sids: Set[str], k: int) -> float:
    """
