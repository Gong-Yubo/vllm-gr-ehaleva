...
SystemEnv = namedtuple(
    ...
    [
        ...
        "vllm_gr_version",  # vllm-gr specific field
...
def get_vllm_gr_version(run_lambda):
    try:
        import vllm_gr
        from vllm_gr import __version__, __version_tuple__
        ...
        package_dir = os.path.dirname(os.path.abspath(vllm_gr.__file__))
        ...
        return "N/A (vllm_gr not installed)"
...
def get_pip_packages(run_lambda, patterns=None):
    ...
    def run_with_pip():
        ...
        if pip_available:
            ...
            return None  # Return None instead of raising RuntimeError

        out = run_and_read_all(run_lambda, cmd)
        if out is None:
            return None  # Handle failure case from run_and_read_all
...
def get_env_info():
    ...
    vllm_gr_version = get_vllm_gr_version(run_lambda)
    ...
    return SystemEnv(
        ...
        vllm_gr_version=vllm_gr_version,
...
vLLM-GR Version              : {vllm_gr_version}
vLLM Build Flags:
  {vllm_build_flags}
GPU Topology:
  {gpu_topo}
